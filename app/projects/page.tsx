            ...
            <div className="group/spotlight relative">
                ...
                <div className="mx-auto min-h-screen max-w-screen-xl px-6 py-12 md:px-12 md:py-20 lg:px-24 lg:py-0">
                    <div className="lg:py-24">
                        ...
                        >
                            <Link className="group mb-6 inline-flex items-center font-semibold leading-tight text-teal-300 hover:text-teal-200 transition-all duration-200" href='/' aria-label="Back to home">
                        ...
                        >
                            A comprehensive collection of projects I've built, showcasing expertise in modern web technologies.
                        </motion.p>
                        <motion.div 
                            ...
                            <table id="content" className="mt-12 w-full border-collapse text-left">
                                ...
                                <tbody>
                                    {MyProjects.map((project, index) =>
                                        <tr key={index} className="border-b border-slate-300/10 last:border-none hover:bg-slate-800/50 transition-colors duration-200">
                                            <td className="td_style text-sm">
                                                <div className="translate-y-px whitespace-nowrap">{project.date}</div>
                                            </td>
                                            <td className="td_style font-semibold leading-snug text-slate-200">
                                                <div>
                                                    <div className="block sm:hidden">
                                                        <a className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 sm:hidden group/link text-base transition-colors duration-200" href={project.link} target="_blank" rel="noreferrer noopener" aria-label={`${project.name} (opens in new tab)`}>
                                            ...
                                            <td className="hidden td_style sm:table-cell">
                                                <ul className="translate-y-1">
                                                    <li className="mb-1 flex items-center">
                                                        <a className="inline-flex items-baseline font-medium leading-tight text-slate-400 hover:text-teal-300 focus-visible:text-teal-300 group/link text-sm transition-colors duration-200" href={project.link} target="_blank" rel="noreferrer noopener" aria-label={`${project.name} website (opens in new tab)`}>
                                                            <span>
                                            ...
                                            <td className="hidden td_style sm:table-cell">
                                                <Link href={project.git} target='_blank' className={clsx('z-20 transition-colors duration-200', !project.git && 'pointer-events-none')} aria-label={`${project.name} GitHub repository`}>
