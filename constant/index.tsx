...
export const Experiences = [
    ...
    },
    {
        ...
        description: 'Completed an intensive front-end development program covering modern web technologies and best practices. Built multiple real-world projects using React and Next.js, gaining hands-on experience with responsive design, accessibility standards, and performance optimization. Collaborated with peers in an agile environment to deliver high-quality web applications.',
