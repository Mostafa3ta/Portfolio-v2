...
export const MyProjects = [
    ...
    { name: 'Quiz App', date: 'Nov 2024', techs: ['React.js', 'Redux', 'MUI',], link: 'https://quiz-app-blue-nine.vercel.app/', git: 'https://github.com/Mostafa3ta/Quiz-App', img: '/Quiz.png', description: 'Flexible quiz app using React, Redux, and MUI. Integrated the TriviaDB API to fetch questions and allow users to customize quiz settings (category, difficulty, number of questions).' },
