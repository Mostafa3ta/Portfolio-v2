...
export const MyProjects = [
    { name: 'MedicaProf', date: 'Feb 2025', techs: ['Next.js', 'Typescript', 'Tailwind CSS', 'Hero UI', 'Framer Motion'], link: 'https://medicaprof.com/en', git: '', img: '/MedicaProf.png', description: "Contributed to the development of a large-scale live medical application for dual user roles (Patients and Doctors), focusing on highly reusable and performant component architecture. Engineered complex interactive features across the platform, including the fully functional Doctor Appointments Calendar and data visualization charts for the analytics dashboard. Implemented Right-to-Left (RTL) layout and localization features, guaranteeing a high-quality, seamless user experience for the application's Arabic-speaking market." },
    ...
    { name: 'Quiz App', date: 'Nov 2023', techs: ['React.js', 'Redux', 'MUI',], link: 'https://quiz-blond-gamma-63.vercel.app/', git: 'https://github.com/Mostafa3ta/Quiz-App', img: '/Quiz.png', description: 'Flexible quiz app using React, Redux, and MUI. Integrated the TriviaDB API to fetch questions and allow users to customize quiz settings (category, difficulty, number of questions).' },
