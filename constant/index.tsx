...
export const MyProjects = [
    ...
    { name: 'Quiz App', date: 'Nov 2024', techs: ['React.js', 'Redux', 'MUI',], link: 'https://quiz-app-blue-nine.vercel.app/', git: 'https://github.com/Mostafa3ta/Quiz-App', img: '/Quiz.png', description: 'Dynamic quiz app using React, Redux, and MUI. Implemented features to allow users to customize the quiz experience by selecting category, difficulty level, and number of questions. Integrated with the TriviaDB API.' },
    { name: 'To-Do App', date: 'Nov 2024', techs: ['React.js', 'Bootstrap',], link: 'https://todo-list-app-eight-omega.vercel.app/', git: 'https://github.com/Mostafa3ta/Todo-List-App', img: '/ToDo-List.png', description: 'Functional To-do list application utilizing JavaScript and local storage. Implemented CRUD operations (Create, Read, Update, Delete) to manage tasks efficientl.' },
    { name: 'Bookmarker', date: 'Oct 2024', techs: ['HTML', 'CSS', 'JavaScript',], link: 'https://bookmarker-green.vercel.app/', git: 'https://github.com/Mostafa3ta/Bookmarker', img: '/Bookmarker2.png', description: '' },
    { name: 'Weather', date: 'Oct 2024', techs: ['HTML', 'CSS', 'JavaScript',], link: 'https://weather-six-blush.vercel.app/', git: 'https://github.com/Mostafa3ta/Weather', img: '/weather.png', description: '' },
    { name: 'Bakery', date: 'Sep 2024', techs: ['HTML', 'CSS',], link: 'https://bakery-seven-delta.vercel.app/', git: 'https://github.com/Mostafa3ta/Bakery', img: '/bakery.png', description: '' },
]
