...
export const MyProjects = [
    { name: 'Movies & Shows', date: 'Feb 2025', techs: ['Next.js', 'Typescript', 'Tailwind CSS','Shadcn UI'], link: 'https://movies-henna-zeta.vercel.app/', git: 'https://github.com/Mostafa3ta/movies', img: '/movies.png', description: 'Developed a responsive Movies & Shows web application using Next.js, leveraging the TMDB API to provide a dynamic and information-rich user experience. Implemented features like advanced search filtering, responsive image galleries, and optimized data fetching for smooth performance.' },
