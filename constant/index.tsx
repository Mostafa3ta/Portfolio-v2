...
export const MyProjects = [
    ...
    { name: 'First Portfolio', date: 'Dec 2023', techs: ['HTML', 'CSS', 'JavaScript', 'Bootstrap',], link: 'https://movies-swart-one.vercel.app/', git: 'https://github.com/Mostafa3ta/Portfolio', img: '/profile-light.png', description: `My first Personal portfolio website, built it using HTML, CSS, and JavaScript. Utilized Bootstrap's grid system for efficient layout and responsiveness.` },
