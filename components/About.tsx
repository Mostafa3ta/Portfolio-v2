...
export default function About() {
  return (<>
    ...
    <div>
      <p className="mb-4">In my previous role as a <span className='text-white'> Front-End Engineer</span> at <a href='https://www.linkedin.com/company/campcoding/' target="_blank" rel="noreferrer noopener" className='about_links'> Camp Coding </a> start-up company , I had
        the opportunity to work on a variety of projects with <span className='text-white'>React
        </span> and <span className='text-white'>Next.js</span> that allowed me to further
        develop my skills and gain practical experience in a professional setting. I
        collaborated closely with designers and backend developers to bring their
        visions to life, ensuring seamless integration of design elements and optimal
        website performance. Additionally, I Maintained and updated existing projects,
        and continuously sought opportunities to expand my knowledge
